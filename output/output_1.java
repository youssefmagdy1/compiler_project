...
if(! __GpreExpression.contains(-1)){System.out.println("GpreExpression_-1");__GpreExpression.add(-1);}}if ((x == 3 || y >= 50) || x==2   )
        {
if(! __if.contains(0)){System.out.println("if_0");__if.add(0);}
            x = 0;
        }else{ 
if(! __GpreExpression.contains(0)){System.out.println("GpreExpression_0");__GpreExpression.add(0);}if( x< 4)
        {
if(! __if.contains(1)){System.out.println("if_1");__if.add(1);}
            x = 1 ;
        }
        else {
if(! __else.contains(1)){System.out.println("else_1");__else.add(1);}
            x=3;
        }
if(! __else.contains(0)){System.out.println("else_0");__else.add(0);}}

    }

    public void output__ () {
if(! __method.contains(1)){System.out.println("method_1");__method.add(1);}
        int z  =1 ;
        
if(! __GpreExpression.contains(1)){System.out.println("GpreExpression_1");__GpreExpression.add(1);}if(z == 1 )
                {z =  0 ;
if(! __if.contains(2)){System.out.println("if_2");__if.add(2);}}
